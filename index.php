...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO table_name (name1, r1, a1, c1, x1, p1, b1, senderBirthday, name2, r2,id) VALUES (:name1, :r1, :a1, :c1, :x1, :p1, :b1, :senderBirthday, :name2, :r2, :id)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([':name1' => $name1, ':r1' => $r1, ':a1' => $a1, ':c1' => $c1, ':x1' => $x1, ':p1' => $p1, ':b1' => $b1, ':senderBirthday' => $senderBirthday, ':name2' => $name2, ':r2' => $r2 ,':id' => $id]);
